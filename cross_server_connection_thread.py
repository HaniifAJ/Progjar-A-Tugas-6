...
MAPPING_SERVER_DOMAIN = {
    "realm1.com" : {"address" : ("172.16.16.101", 9000), "password" : "realm1" },
    "realm2.com" : {"address" : ("172.16.16.102", 9000), "password" : "realm2" },
    "realm3.com" : {"address" : ("172.16.16.103", 9000), "password" : "realm3" }
}
